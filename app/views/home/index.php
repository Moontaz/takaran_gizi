      ...
      <div class="m-4 mt-5">
         ...
         <div class="card-container row row-1 g-5 justify-content-around">
            <div class="card col-12 col-lg-3 card-cs">
               ...
               <div class="card-body">
                  <p class="card-text">
                     Melibatkan asupan nutrisi penting seperti karbohidrat, protein, lemak, vitamin, mineral, dan air,
                     penting untuk menopang kehidupan dan meningkatkan fungsi tubuh. Membuat pilihan berdasarkan
                     informasi mengenai makanan memastikan pola makan seimbang yang disesuaikan dengan kebutuhan
                     individu, mendukung pertumbuhan, perkembangan, dan kesejahteraan secara keseluruhan.
                  </p>
            ...
            <div class="card col-12 col-lg-3 card-cs">
               ...
               <div class="card-body">
                  <p class="card-text">
                     Senyawa organik penting untuk proses fisiologis, memainkan peran penting dalam metabolisme, fungsi
                     kekebalan tubuh, dan pertumbuhan sel. Diklasifikasikan ke dalam jenis yang larut dalam lemak dan
                     larut dalam air, sumbernya berasal dari berbagai makanan dan kekurangan atau kelebihan asupannya
                     dapat berdampak signifikan pada kesehatan.
                  </p>
      ...
      <div class="form-container mx-auto p-4 rounded-3">
         ...
         <form id="myForm">
            ...
            <div class="btn-group btn-cs">
               <button type="button" id="disabledInput" class="btn btn-primary" data-bs-toggle="modal"
