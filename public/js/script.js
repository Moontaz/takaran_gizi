document.getElementById("gender").addEventListener("change", function () {
  ...
  if (gender === "") {
    ...
    hamilOrMenyusuiDiv.innerHTML = `
    <label id="kondisiKhusus" for="kondisiKhusus" class="col-sm-2 col-form-label">Kondisi Khusus</label>
...
document
  ...
  .addEventListener("change", function () {
    ...
    if (hamilMenyusui === "tidak-keduanya") {
      ...
      umurHamilOrMenyusuiDiv.innerHTML = `
        <label id="keterangan" for="keterangan" class="col-sm-2 col-form-label">${umurText}</label>
